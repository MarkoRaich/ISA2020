...
public class EditPharmacyDTO {
	...
	public EditPharmacyDTO(Long id,
	...
	public EditPharmacyDTO(String name, String address) {
		this.name = name;
		this.address = address;
	}
	
	public EditPharmacyDTO(String name) {
		this.name = name;
	}
	
	
	public EditPharmacyDTO(Pharmacy pharmacy) {
